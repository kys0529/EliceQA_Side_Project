...
class TestTP01:
    ...
    def test_tp_01_01(self, login_driver: WebDriver, request): # 채팅 탭 진입
        ...
        chat_tab_element = chatting.find_element(ChattingLocator.CHATTING_TAB)
    ...
    def test_tp_01_02(self, login_driver: WebDriver, request): # 채팅 탭 UI요소 확인
        ...
        chatting = Chatting(login_driver)
        chatting.into_chatting_tap(self)
        ...
        search_input = chatting.find_element(ChattingLocator.SEARCH_INPUT)
